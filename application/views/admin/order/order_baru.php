...
<table cellspacing="0" cellpadding="3px">
    <tr>
		...
		<?php foreach($fields as $field_name => $field_display): ?>
			...
			<?php echo anchor("/admin/order/order_baru/$field_name/".(($sort_order == 'asc' && $sort_by == $field_name) ? 'desc' : 'asc'), $field_display); ?>
			</th>
		<?php endforeach; ?>
    </tr>
<?php foreach ($laporan as $item): ?>
    <tr>
        <td align="center"><?php echo anchor(site_url().'/admin/order/detail/'.$item->id_order, '.:: '.$item->id_order.' :: Detail ::.', 'class="active" id="detail"') ?></td>
		...
		//echo $item->status_order_text; ?></td>
    </tr>
    <tr>
        <td></td>

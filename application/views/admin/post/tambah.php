<div id="main">
	<div class="full_w">
		...
		<?php echo form_open('admin/post/proses_tambah') ?>
			<div class="element">
				<label for="name">Judul Post <span class="red">(required)</span></label>
				<input id="name" name="judul_post" class="text err" />
			</div>
			<div class="element">
				<label for="name">Detail Post</label>
				<textarea name="detail_post" class="textarea artikel"></textarea>
			</div>
			<!--<div class="element">
			...
			<div class="entry">
				<!--<button type="submit">Preview</button>--> <button type="submit" class="add">Tambah Post</button> <button class="cancel">Cancel</button>
			</div>
		</form>
	</div>
</div>
